...
AP_2015_PATH="/ads/arton/AP/build2015/build.15.02/bin/rhel6-64"
...
alias daily1502-564="/integ/release/15.02/LATEST/build.15.02/bin/rhel5-64/AP"
alias local1502="/ads/arton/AP/build2015/build.15.02/bin/rhel6-64/AP"
...
switch_env() {
    if [ "$1" == "09" ] || [ "$1" == "12" ] ||  [ "$1" == "14" ]; then
        ...
        export LD_LIBRARY_PATH="/ads/rel_tools2/standard-20$1/$GPLAT/lib:/ads/rel_tools2/standard-20$1/$GPLAT/lib64:/ads/arton/build/python2.7/lib:/ads/arton/build/llvm/lib"
